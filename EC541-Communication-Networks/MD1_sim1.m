...
% Jonathan Chamberlain, 04/23/2018, as modfied from MD1_sim.m, David 
% Starobinski, 03/31/2016
...
for j=1:length(lambda) % iterate over values of lambda
    ...
    for k=1:iteration_num; % for each value of lambda run iteration_num iterations
        ...
        serv_time = unifrnd(0.2,1.8); % for M/G/1 queue, uniformly distributed between 0.2, 1.8
